...
public class ExtendedSimpleAdapter extends SimpleAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        return this.createViewFromResourse(position,convertView,parent,layout);
    }

    private View createViewFromResourse(int position,View convertView,ViewGroup parent,int resource){
        View v;
        if (convertView==null){
    ...
    private void setViewImage(ImageView v,Bitmap bmp){v.setImageBitmap(bmp);}
